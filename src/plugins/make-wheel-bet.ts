...
const Wheels: Record<string, Record<number, number[]>> = {
  ...
  MEDIUM: {
    30: [
      0.0, 2.0, 0.0, 1.5, 0.0, 1.5, 0.0, 2.0, 0.0, 1.5, 0.0, 2.0, 0.0, 2.0, 0.0,
      1.5, 0.0, 3.0, 0.0, 1.5, 0.0, 2.0, 0.0, 2.0, 0.0, 1.7, 0.0, 4.0, 0.0, 1.5,
    ],
    50: [
      0.0, 2.0, 0.0, 1.5, 0.0, 1.5, 0.0, 5.0, 0.0, 1.5, 0.0, 2.0, 0.0, 1.5, 0.0,
      2.0, 0.0, 1.5, 0.0, 2.0, 0.0, 1.5, 0.0, 3.0, 0.0, 1.5, 0.0, 1.5, 0.0, 2.0,
      0.0, 1.5, 0.0, 3.0, 0.0, 1.5, 0.0, 2.0, 0.0, 1.5, 0.0, 2.0, 0.0, 2.0, 0.0,
      1.5, 0.0, 3.0, 0.0, 1.5,
    ],
  },
  HIGH: {},
